import { View, Text ,Alert,StyleSheet,Image,
...
import {  deleteDoc, getDoc,collection, getDocs,addDoc,updateDoc,doc ,set,setDoc} from "firebase/firestore"; 
...
const user= auth.currentUser;
  ...
  const uploadImage = async () => {
    ...
    const storageRef = ref(storage, 'UsersImages/' + filename);
