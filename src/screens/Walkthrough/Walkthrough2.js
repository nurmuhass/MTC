...
import {COLORS,SIZES,constants,FONTS,images} from '../../components/constants'
import { useEffect } from 'react';
import {useDynamicAnimation,MotiImage} from "moti";

export default function Walkthrough2({animate}) {
...
useEffect(() =>{
  ...
  return (
    <View style={{flex:1,overflow:'hidden'}}>
      <Image source={images.walkthrough_02_01} style={{
      ...styles.image,top:'35%',
      left:'35%',
      width:106,
      height:161,
...
<Image source={images.walkthrough_02_02} style={{
      ...styles.image,
      top:'50%',
      left:'50%',
